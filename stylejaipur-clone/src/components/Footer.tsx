        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/exchange" className="hover:text-white transition">
                  Exchange Request
                </Link>
              </li>
            </ul>
            <div className="mt-4 text-sm">
              <p className="mb-2">
                <strong>Location:</strong> F834,F835, 3rd Phase, Sitapura Industrial Area, Sitapura, Jaipur- 302022
              </p>
              <p className="mb-2">
                <strong>Timing:</strong> Mon-Sat - 10.00 AM to 5.30 PM (IST)
              </p>
              <p>
                <strong>Email:</strong> order@advikcreation.com
              </p>
            </div>
          </div>
        </div>
